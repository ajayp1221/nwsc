...
class SubjectsController extends AppController
{
    ...
    {
        $qry = $this->Subjects->find()->where([
            'school_id' => $this->Auth->user('school_id')
        ]);
        $subjects = $this->paginate($qry);
    ...
    public function view($id = null)
    {
        $subject = $this->Subjects->get($id, [
            'contain' => ['Schools', 'Results', 'Timetables']
        ]);
    ...
    public function add()
    {
        ...
        $schools = $this->Subjects->Schools->find('list', ['limit' => 200]);
        $this->set(compact('subject', 'schools'));
        $this->set('_serialize', ['subject']);
    }
