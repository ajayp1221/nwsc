                    ...
                    <div class="col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Your Time Table</h3>
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            foreach ($timetables['Tuesday'] as $tuesdaytimetable) {
                                                ...
                                                ?>
                                                <td>
                                                    <?php echo strtoupper($tuesdaytimetable->classroom->class_name);?><br/>
                                                    <?php echo $tuesdaytimetable->subject->name; ?><br/>
                                                    <?php echo $tuesdaytimetable->period_time; ?>
                                                </td>
                                                <?php $lastPeriod = $tuesdaytimetable->period_no;
                                                ?>
                                            <?php } if($lunch <=$settings[4]['value']){
                                                for($i = $lunch;$i<=$settings[4]['value'];$i++){?>
                                                    <td>No-Period</td>
                                        ...
                                        <tr>
                                            ...
                                            foreach ($timetables['Wednesday'] as $wednestimetable) {
                                                ...
                                                ?>
                                                <td>
                                                    <?php echo strtoupper($wednestimetable->classroom->class_name);?><br/>
                                        ...
                                        <tr>
                                            ...
                                            foreach ($timetables['Thursday'] as $thursdaytimetable) {
                                                ...
                                                ?>
                                                <td>
                                                    <?php echo strtoupper($thursdaytimetable->classroom->class_name);?><br/>
                                        ...
                                        <tr>
                                            ...
                                            foreach ($timetables['Friday'] as $fridaytimetable) {
                                                ...
                                                ?>
                                                <td>
                                                    <?php echo strtoupper($fridaytimetable->classroom->class_name);?><br/>
                                        ...
                                        <tr>
                                            ...
                                            foreach ($timetables['Saturday'] as $saturdaytimetable) {
                                                ...
                                                ?>
                                                <td>
                                                    <?php echo strtoupper($saturdaytimetable->classroom->class_name);?><br/>
