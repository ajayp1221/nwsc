...
/**
 * SeenotificationsFixture
 *
 */
class SeenotificationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'guardians_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'is_seen' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'is_seen_date' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'teacher_id' => 1,
            'is_seen' => 1,
            'is_seen_date' => 'Lorem ipsum dolor ',
            'created' => 1,
            'modified' => 1
        ],
    ];
